...
/**
 * LocalBusiness / InsuranceAgency — reforça sinais locais para o SEO.
 */
export function buildLocalBusinessJsonLd() {
  return {
    ...
    sameAs: [SITE_CONFIG.social.instagram, SITE_CONFIG.social.linkedin],
  } as const;
}

/**
 * FAQPage — gera o JSON-LD a partir dos itens de FAQ da página.
 */
